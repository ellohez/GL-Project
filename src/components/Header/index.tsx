    ...
    <header>
      <div className="svg-logo-div">
        <svg
          ...
          viewBox="0 0 800 270"
        >
          {/* Title used in place of alt text which is not available on SVG */}
          ...
          <path
            d="M167.93,184.54h3.71v3.39h-3.71v9.12c0,1.71.43,2.14,2.14,2.14a7,7,0,0,0,1.57-.14V203a18.54,18.54,0,0,1-3,
          .18c-3.14,0-5.81-.67-5.81-4.38V187.93h-3.06v-3.39h3.06V179h5.06Z"
          />
          <path
            d="M174.56,190.21c.28-4.7,4.52-6.16,8.66-6.16,3.67,0,8.09.82,8.09,5.23v9.59A9.49,9.49,0,0,0,192,
          203h-5.13a7.71,7.71,0,0,1-.36-1.78,8.41,8.41,0,0,1-6.2,2.28c-3.53,0-6.27-1.75-6.27-5.53.07-8.37,12.47-3.88,
          12.26-8,0-2.14-1.5-2.5-3.28-2.5-2,0-3.17.79-3.35,2.78ZM186.25,194c-.86.75-2.64.79-4.21,1.07s-3,.86-3,2.71,1.46,2.35,
          3.1,2.35c4,0,4.1-3.1,4.1-4.24Z"
          />
          ...
          <path
            d="M722.61,75a8.24,8.24,0,1,1,8.25,8.36A8.18,8.18,0,0,1,722.61,75Zm15.2,0c0-4.21-2.94-7.3-6.95-7.3s-6.93,
          3.09-6.93,7.3a6.95,6.95,0,1,0,13.88,0Zm-10.22-4.55h4.15a2.6,2.6,0,0,1,2.87,2.52,2.09,2.09,0,0,1-1.8,2.14v0c1,
          .26,1.37.78,1.49,1.86.14,1.23.14,2.15.42,2.26v.15H733c-.26-.12-.29-1.06-.37-2.09a1.49,1.49,0,0
          ,0-1.7-1.52h-1.6v3.61h-1.75Zm1.75,4h2c1,0,1.53-.51,1.53-1.28s-.5-1.26-1.5-1.26h-2Z"
          />
        </svg>
      </div>
